...
import { DiscountbillsService } from './discountbills.service';
import { DatePipe } from '@angular/common';

@Component({
  selector: 'app-discount-bills',
  templateUrl: './discount-bills.component.html',
  styleUrls: ['./discount-bills.component.css']
})
export class DiscountBillsComponent implements OnInit {
  ...
  constructor(private myService:DiscountbillsService,public datepipe:DatePipe) { }
  records: any[];
  fdate;
  tdate;
  p_goldgwt: number = 0;
  ...
  ngOnInit(): void {
    ...
    this.LoadRecords();
    this.records=this.records.filter(x => !x.dis.includes(0));     
